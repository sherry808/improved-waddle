...
export default function ExpandableContent({
  ...
  return (
    <div className="mt-4 xl:mt-10">
      ...
      <p className="font-nats text-[12px] lg:text-[16px] leading-[26px] text-[#351A12] mx-auto lg:mx-0">
        {displayedContent}
      </p>
      {showReadMore && (
        <p className="font-nats text-[12px] lg:text-[16px] leading-[26px] text-[#351A12] mx-auto lg:mx-0 mt-0">
          <button

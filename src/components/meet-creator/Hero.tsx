  ...
  return (
    <section id="about" className="pb-0 md:pt-[80px] md:pb-16">
      ...
      <div className="px-[30px] md:px-[103px] pb-[50px] md:pb-[80px]">
        {/* Mobile Layout */}
        <div className="md:hidden">
          <h2 className="font-normal text-[15px] font-nats text-[#351A12] pt-[50px] mb-[20px] mt-0 m-0 p-0 uppercase">
            Meet the Creator
          </h2>
          <h3 className="font-normal text-[64px] font-monthis text-[#351A12] leading-none mt-0 mb-[30px] m-0 pt-0 pb-0">
            Mili Bajaj
          </h3>
        ...
        <div className="hidden md:flex md:gap-[100px]">
          ...
          <div className="relative w-[425px] h-[410px] flex-shrink-0">
            ...
            <h3 className="font-normal absolute top-[196px] left-[385px] text-[64px] md:text-[128px] font-monthis text-[#351A12] whitespace-nowrap leading-none">
              Mili Bajaj
            </h3>
          </div>

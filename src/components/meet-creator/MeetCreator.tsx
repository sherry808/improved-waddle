...
const MeetCreator: React.FC = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full font-nats overflow-hidden px-[30px] py-11 lg:p-[50px] xl:py-[70px] desktop-xl:pl-[102px] desktop-xl:pr-[104px] desktop-xl:pb-[100px] bg-[#F0E5D4] justify-between">
      <div className="w-full lg:w-[40%] xl:w-[30%] lg:pt-7 h-auto text-left">
      ...
      <div className="w-full lg:w-[60%] xl:w-[70%] flex flex-col justify-start pl-0 lg:pl-7 desktop-xl:pl-[19px] desktop-xl:pt-7">
        {renderContent()}
      </div>
    </div>
  );

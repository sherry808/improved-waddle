...
const MeetCreator: React.FC = () => {
  ...
  const allParagraphs = [
    ...
    `Today, Mili partners with Sherry, a full-stack developer and technologist who thrives across the digital spectrum, from modern frameworks and scalable systems to emerging technologies like AI and Web3. Together, they create digital experiences where visual expression meets functionality.`,
  ];
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full font-nats overflow-hidden px-[30px] py-11 lg:p-[50px] xl:pt-[94px] xl:pb-[100px] desktop-xl:px-[104px] bg-[#F0E5D4] justify-between">

...
const MeetCreator: React.FC = () => {
        ...
        <div className="lg:hidden">
          ...
          <div className="font-nats text-[12px] leading-[33px] text-[#351A12] mx-auto mt-0 flex justify-center">
            <button
              ...
              className="inline-block w-full text-center px-6 mt-4 font-nats font-normal text-[15px] lg:text-[20px] text-[#351A12] uppercase bg-[#D2ADCE] transition-all duration-300 hover:scale-105"
            >
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full font-nats overflow-hidden px-[30px] py-10 lg:p-[50px] xl:p-[70px] desktop-xl:p-[100px] bg-[#F0E5D4] justify-between">
      ...
      <div className="w-full lg:w-[60%] xl:w-[70%] flex flex-col justify-start pl-0 lg:pl-7 desktop-xl:pl-4">
        {renderContent()}
      </div>
    </div>
  );

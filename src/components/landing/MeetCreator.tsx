...
export default function MeetCreator() {
  return (
    <section
      id="about"
      className="pt-[50px] pb-0 md:pt-[80px] md:pb-16 bg-[#351A12]"
    >
      <div className="px-[30px] md:px-[103px] pb-[50px] md:pb-[80px]">
        <h2 className="font-normal text-[15px] md:text-[20px] font-nats text-tertiary mb-0 md:mb-0 md:pb-[40px] uppercase">
          Meet the Creator
        </h2>
        <h3 className="m-0 p-0 pb-[15px] font-normal text-[64px] md:text-[128px] font-monthis text-[#D2ADCE] md:hidden">
          Mili Bajaj
        </h3>
        ...
        <div className="md:hidden">
          ...
          <div className="space-y-6">
            ...
            <p className="text-[12px] md:text-[16px] font-nats text-[#F7F5ED] mb-[25px]">
              and digital platforms, her solutions are both aesthetically
              refined and results-driven. She now partners with Sherry, a
              technologist working across the digital spectrum, from modern
              frameworks to emerging tech like AI and Web3. Together, they build
              websites and digital experiences that perform.
            </p>
          </div>
        ...
        <div className="hidden md:flex md:gap-[100px]">
          ...
          <div className="relative w-[425px] h-[410px] flex-shrink-0">
            ...
            <h3 className="font-normal absolute top-[196px] left-[385px] text-[64px] md:text-[128px] font-monthis text-[#D2ADCE] whitespace-nowrap p-0 m-0 leading-none">
              Mili Bajaj
            </h3>
          </div>
          ...
          <div className="relative w-[300px] h-[410px] flex-shrink-0">
            <div className="absolute top-0 left-0 right-0 bottom-0 flex items-start pt-0">
              <p className="text-[12px] md:text-[16px] font-nats text-[#F7F5ED]">
                ...
                multidisciplinary teams across print and digital
              </p>
            </div>
          </div>

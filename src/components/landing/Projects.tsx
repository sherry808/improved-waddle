        ...
        <section id="projects" className="py-20 bg-[#F0E5D6]">
            <div className="px-[30px] md:px-[103px]">
                ...
                >
                    <Link
                        href="/projects"
                        className="inline-block w-[300px] h-[32px] md:w-[232px] md:h-[42px] bg-[#D2ADCE] text-[#351A12] font-nats flex items-center justify-center uppercase text-[15px] md:text-[20px]"
                    >
                        Browse All Projects
                    </Link>
                </motion.div>

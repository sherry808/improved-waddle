...
const DirectionAndExperience: React.FC<DirectionAndExperienceProps> = (
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full bg-[#351A12] font-nats overflow-x-hidden p-12">
      <div className="lg:w-1/2 w-full flex items-center justify-start pl-8">
        <h2 className="m-0 font-monthis font-normal text-[54px] text-[#D2ADCE] leading-tight">
          {props.pageTitle}
        </h2>
      </div>
      <div className="lg:w-1/2 w-full flex items-center justify-center pr-8">
